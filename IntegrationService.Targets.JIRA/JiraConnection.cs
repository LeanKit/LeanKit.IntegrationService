...
{
	public interface IJiraConnection : IConnection
	{
		void AddSessionCookieToRequest(RestRequest request);
		Dictionary<string, string> GetSessionCookie(string host, string user, string password);
	}
	...
	public class JiraConnection : IJiraConnection
	{
		...
		public Dictionary<string, string> GetSessionCookie(string host, string user, string password)
		{
